...
#
#
#np.save('hw2_gd_adagrad_norm.npy',weights)
#np.save("hw2_gd_adagrad_norm_bias.npy",bias)

weights = np.load('hw2_gd_adagrad_norm.npy')
bias = np.load('hw2_gd_adagrad_norm_bias.npy')
